  ...
  return (
    <footer style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      <div style={{
        ...
        {/* Full Width Background Video (Using reliable local MP4 sources to prevent CORS blocks & static image fallback) */}
        <video
          autoPlay
          loop
          muted
        ...
        >
          ...
          <source src="/products/gemini_generated_video_4fc71452.mp4" type="video/mp4" />
          <source src="/products/gemini_generated_video_5bb3fbc4.mp4" type="video/mp4" />
        </video>
      ...
      <div style={{
        ...
        <div className="container">
          ...
          >
            {/* Brand Minimalist Column */}
            <div>
              <div style={{ marginBottom: '22px' }}>
                <HeerLogo isLightPage={false} style={{ filter: 'brightness(1.15) drop-shadow(0 2px 10px rgba(0,0,0,0.8))' }} />
              </div>
